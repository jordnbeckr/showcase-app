...
function getDeadlineBanner() {
  // Deadlines: entry 9/14/2025, headcount 9/15/2025
  const now = new Date()
  ...
  // Use the nearest upcoming deadline
  ...
  if (days !== null && days <= 2) {
    ...
    bg = 'var(--surface2, #f3f4f6)'; text = 'var(--muted)'; border = 'var(--border)'
  }
